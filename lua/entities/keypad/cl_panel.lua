surface.CreateFont("KeypadDel", {font = "Roboto", size = 45, weight = 900})
surface.CreateFont("KeypadID", {font = "Roboto", size = 70, weight = 900})
surface.CreateFont("wl", {font = "Roboto", size = 35, weight = 900})
...
local elements = {
	...
	{ -- ID
		...
		w = 0.25,
		h = 0.125,
		color = Color(25, 25, 120),
		hovercolor = Color(25, 25, 180),
		text = "ID",
		font = "KeypadID",
		click = function(self)
	...
	{ -- Wl
		...
		hovercolor = Color(0, 173, 173),
		text = "Manage Whitelist",
		font = "wl",
		click = function(self)
			self:SendCommand(self.Command_Manage)
		end
	}
}
